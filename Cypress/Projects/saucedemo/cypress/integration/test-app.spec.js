...
describe('YouLend Test 1', () => {
    ...
    it('Bonus Points - Error (1) with item name', () => {
        ...
        cy.get('div[class="inventory_details_desc_container"]')
            .should('contain', 'Sauce Labs Backpack')
    ...
    it('Bonus Points - Error (6) Problem with the menu when you click All Items, page does not load adn the menu does not desappear', () => {
