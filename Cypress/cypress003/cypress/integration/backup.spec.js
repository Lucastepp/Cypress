...
describe('YouLend Test 1', () => {
    ...
    it('Checking the sum', () => {
        ...
        //expect('div[class="inventory_item_price"]').eq(0).to.eq('29.99')
    ...
    it('Bonus Points - Error (3) Returning to products and trying add button not working', () => {
